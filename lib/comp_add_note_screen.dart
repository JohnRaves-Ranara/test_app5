...
class comp_add_note_screen extends StatefulWidget {
  ...
  comp_add_note_screen({this.LT_note_ID,required this.loggedInUser, required this.LT_goal_info, required this.isUpdate, required this.note_text_text, required this.note_title_text});

  @override
  State<comp_add_note_screen> createState() => _comp_add_note_screenState();
}

class _comp_add_note_screenState extends State<comp_add_note_screen> {
